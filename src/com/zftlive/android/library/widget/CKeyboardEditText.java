 ...
 *
 */
public class CKeyboardEditText extends EditText implements OnKeyboardActionListener {
	 ...
	 * @param attrs
	 */
	public CKeyboardEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param defStyle
	 */
	public CKeyboardEditText(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initKeyboard(Context context, AttributeSet attrs){
		...
		if(a.hasValue(R.styleable.keyboard_xml)){
			...
			mKeyboardView = (KeyboardView)LayoutInflater.from(context).inflate(R.layout.view_mykeyboard, null);
			...
			mKeyboardWindow.setAnimationStyle(R.style.KeyboardAnimationFade);
